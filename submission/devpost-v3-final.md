...
- Video: the verified public-v3 [2:13 YouTube demo](https://youtu.be/UZaS9vG9Mkw) opens with the Codex + official Chrome DevTools for agents Tier A run; it uses disclosed AI-generated narration, authored English subtitles, no AI-generated images, comments disabled, and explicit boundaries between edited real-agent evidence, the deterministic runner, and separate native Chrome Reset evidence.
